...
typedef enum {
    ...
    ES_EV_GAME_WIN,
    ES_EV_GAME_OVER,
    ES_EV_GAME_LIFE_LOST,
    ES_EV_GAME_DECREASE_BRICKS_COUNT,
    ES_EV_GAME_INCREASE_SCORE,

    ES_EV_PADDLE_MOVE_NONE,
    ES_EV_PADDLE_MOVE_LEFT,
    ES_EV_PADDLE_MOVE_RIGHT,
    ES_EV_PADDLE_RESET,

    ES_EV_BALL_LAUNCHED,
    ES_EV_BALL_HIT_WALL,
    ES_EV_BALL_HIT_PADDLE,
    ES_EV_BALL_HIT_BRICK,
    ES_EV_BALL_RESET,

    ES_EV_BRICK_LIFE_LOST,

    ES_EV_SFX_PLAY_BOUNCE,
    ES_EV_SFX_PLAY_WALL_HIT,
